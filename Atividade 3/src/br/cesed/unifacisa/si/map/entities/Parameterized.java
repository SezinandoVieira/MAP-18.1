package br.cesed.unifacisa.si.map.entities;
...
class Parameterized  { 
    ...
    private static class HB20 implements Car {
    	public String showInfo() {return "HB20. Hatch from Hiunday";}
    }
    
    private static class Sonata implements Car {
    	public String showInfo() {return "Sonata. Sedan from Hiunday";}
    }
    ...
    public static void main(String []args) {
        ...
        System.out.println("Hyunday factory creates " + hyundai.createCar(Type.HATCH).showInfo());
